...
//
//  Created by WCTM 08 on 23/10/24.
//
...
class cat1ViewController: UIViewController ,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UITextFieldDelegate{

    @IBOutlet weak var collection: UICollectionView!
    // we make outlet so that the we can handle the runtime changes in the ui or display
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collection.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! cat1CollectionViewCell
...
// if we are using the array globally we have to use  self with the variable
//  we can also count these images by using for loop instead of using if else condition 


// another method of approaching the viewcontroller which carry information to the next view controller
// var limit = varname.count
// var myindex = limit

// for i in 0...limit{
//     if(i == myindex){
//         let vc = storyboard?.instantiateViewController(identifier: "viewController") as! viewController
//         vc.image = img[myindex]
//         self.navigationController?.pushViewController(vc, animated: "true")
// ? :- optional unrapping
// ! :- force unrapping
//     }
